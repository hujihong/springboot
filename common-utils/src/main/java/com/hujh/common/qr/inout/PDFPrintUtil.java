package com.hujh.common.qr.inout;
...
/**
 * 处理编辑pdf内容，可以向pdf模板中添加图片、文本
 * 文本需要pdf通过Adobe Acrobat DC制作text input字段
 * 还有一种方式是将svg中使用占位符，如${username}然后通过freemarker将占位符替换后再生成pdf来替换文本信息字段
...
public class PDFPrintUtil {
    ...
    public static void createPdfByTemplate(String templateFile, String outFilePath,
                                           Map<String, Object> params, String imagePath)
